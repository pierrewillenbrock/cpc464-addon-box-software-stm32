...
struct SIGC_API signal_impl
{
  ...
  inline bool empty() const noexcept
    { ISR_Guard g; return slots_.empty(); }
...
struct SIGC_API signal_base : public trackable
{
   ...
   */
  inline bool empty() const noexcept
    { ISR_Guard g; return (!impl_ || impl_->empty()); }

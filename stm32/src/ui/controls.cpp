...
ui::Palette ui::palette = {
  ...
  .input_normal = {15, 2},
  .input_cursor = {15, 2},
  .input_selection = {14, 0},
  .input_navigate = {14, 0},
  .input_navigate_cursor = {14, 0},
  .input_navigate_selection = {15, 1},
  .input_selected = {15, 2},
  .input_selected_cursor = {15, 1},
  .input_selected_selection = {14, 0},
  .listbox_background = {15, 2},
  .listbox_item = {15, 2},
  .listbox_selection = {15, 1},
  .listbox_navigate_background = {14, 0},
  .listbox_navigate_item = {14, 0},
  .listbox_navigate_selection = {15, 1},
  .listbox_selected_background = {15, 2},
  .listbox_selected_item = {15, 2},
  .listbox_selected_selection = {14, 0},
  .button_normal = {15, 3},
  .button_focus = {14, 0},
  .button_pressed = {15, 2},
  .button_deco = {15, 3},
  .button_focus_deco = {14, 0},
  .button_pressed_deco = {15, 2},
  .scrollbar_page = {15, 3},
  .scrollbar_pressed_page = {15, 2},
};
